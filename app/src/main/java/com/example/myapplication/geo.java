 ...
 */
public class geo extends AsyncTask<String, Void, geo.Point[]> {

    private final static String NAVER_CLIENT_ID = "w9parjdwvh";
    private final static String NAVER_CLIENT_SECRET = "HMJAysT2Msszeio9MdOKSUlaRUFtXlod0YTZVRvV";

    private OnGeoPointListener onGeoPointListener;

    private Context context;

    public geo(MainActivity context, OnGeoPointListener listener) {
